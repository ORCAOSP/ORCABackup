...
public class Tools {
    ...
    public static File getBackupDirectory(Context c) {
        ...
        if (Prefs.getBackupPermanent(c)) {
            f = new File(Environment.getExternalStorageDirectory(), "ORCA_Backup");
        } else {
    ...
    public static String getROMVersion() {
        ...
        String bigfootVersion = Tools.getInstance().getProp("ro.bigfoot.version");
        if (modVersion != null)
            return modVersion;
        else if (cmVersion != null)
            return cmVersion;
        else if (bigfootVersion != null)
            return bigfootVersion;
        else
            return "<none>";
    }

    public static Integer getORCAGooVersion() {
    ...
    public static void delete(File f) throws IOException {
        ...
        if (!f.delete())
            ...
            Log.d("ORCA.Backup", "Failed to delete file: " + f);
    }
